...
if __name__ == "__main__":
    ...
    segmentation_model = load(SEGMENTATION_MODEL_PATH)

    train_data, test_data, train_labels, test_labels = load_archive_into_dataset_segment(
        segmentation_model,
    ...
    autopilot_model = AutopilotModelSegment(env_name=args.env_name, 
                                     input_shape=INPUT_SHAPE_SEGMENTATION, 
                                     predict_throttle=args.predict_throttle)
